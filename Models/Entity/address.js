...
function address(id, location, block, road, house, apartment, postal_code, start, finish){
    let _id = id;
...
let createFromJson = function (json){
    return new address(json.id, json.location, json.block, json.road, json.house,
